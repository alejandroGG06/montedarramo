...
/**
 * Servicio encargado de gestionar las operaciones relacionadas con las reunions.
 * Incluye métodos para crear, obtener, actualizar y eliminar reunions.
...
public class ReunionService {
   ...
   *
   * @param reunionRepository El repositorio de jornadas para interactuar con los datos.
   * @since 1.0
   */
  @Autowired
  public ReunionService(ReunionRepository reunionRepository) {
    this.reunionRepository = jornadaRepository;
  }

  /**
   * Crea un nuevo reunion en el sistema.
   *
   * @param reunion El objeto jornada que se desea crear.
   * @return La reunion creado, incluyendo el ID asignado.
   * @since 1.0
   */
  public Reunion crearReunion(Reunion reunion) {
    return (Reunion) reunionRepository.save(jornada);
  }

  /**
   * Obtiene todas las reunions almacenados en la base de datos.
   *
   * @return Una lista con todas las reunions.
   * @since 1.0
   */
   ...
   * @param reunion El objeto jornada con la nueva información.
   * @return La reunion actualizado, o lanza una excepción si la jornada no existe.
   ...
   * @return true si la reunion fue eliminado correctamente, false si la jornada no existe.
   * @since 1.0
   */
